# CURE: CONSERVATIVE UNLEARNING VIA GRADIENT-BASED INFLUENCE REWEIGHTING FOR OFFLINE REINFORCEMENT LEARNING

The below content is from the `README.md` file from the TrajDeleter GitHub repo. Please follow the TrajDeleter's setup step to run our code as well.

Additional setup steps are mentioned in the `README.md` inside the ``unlearning" folder.
